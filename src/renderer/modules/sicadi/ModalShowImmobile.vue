        ...
        <div class="modal-content roundbox boxshadow">
          ...
          <div class="modal-body" style="padding: 5px !important">
            ...
            <div
              ...
              v-show="!loading"
            >
              <table class="table table-condensed table-hover" style="margin-top: 5px; margin-bottom: 0px">
                <thead>
                  <tr>
                    <th>Código</th>
                    <th>Endereço</th>
          ...
          <modal-footer>
            <button class="button btn btn-sm btn-default"  @click="closeModal">Fechar Janela</button>
          </modal-footer>
        </div>
      </div>
    </div>
